...
<body>
	...
	<table width="100%" border="0" align="center">
		<tr>
			...
			<td><div align="center" class="text4">
					一 口 價：<span class="title">￥${goods.price}</span>
				</div> <br>
				...
				<div>
					<a
						href="Controller?action=add&pagename=detail&id=${goods.id}&name=${goods.name}&price=${goods.price}">
