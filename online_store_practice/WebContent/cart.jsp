		...
		<table width="100%" border="0" align="center" class="threeboder">
			...
			<c:forEach var="row" items="${cart}">
				<tr>
					...
					<td align="center" class="trow"><input
						name="quantity_${row.goodsid}" type="text"
						value=${row.quantity
					} onblur="calc(${row.goodsid}, this)" /></td>
					<td align="center" class="trow">&yen;<span
						id="price_${row.goodsid}">${row.price}</span></td>
					<td align="center" class="trow">&yen;<span
			...
			<tr>
				<td height="50" colspan="5" align="right">合計：&yen;<span
					id="total">${total}</span>&nbsp;&nbsp;
				</td>
			</tr>
		</table>
